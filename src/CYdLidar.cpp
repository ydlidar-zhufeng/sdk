...
bool  CYdLidar::doProcessSimple(LaserScan &scan_msg, bool &hardwareError) {
  ...
  if(!sn_status){
      ...
      m_LidarVersion.sn[16] = year/1000 + 48;
      m_LidarVersion.sn[17] = (year%1000) /100 +48;
      m_LidarVersion.sn[18] = (year%100) /10 + 48;
      m_LidarVersion.sn[19] = year%10 +48;
      m_LidarVersion.sn[20] = month /10 +48;
      m_LidarVersion.sn[21] = month %10 +48;
      m_LidarVersion.sn[22] = day /10 +48;
      m_LidarVersion.sn[23] = day %10 +48;
      m_LidarVersion.sn[27] = sn_ / 10000 + 48;
      m_LidarVersion.sn[28] = (sn_ % 10000) / 1000 + 48;
      m_LidarVersion.sn[29] = (sn_ % 1000) / 100 + 48;
      m_LidarVersion.sn[30] = (sn_ % 100) / 10 + 48;
      m_LidarVersion.sn[31] = sn_ % 10 +48;
      m_LidarVersion.sn[32] = 0; //'\0'
